...
interface Props {
  solution: DailyPuzzleResponse["solution"];
}

export default function SolutionReveal({ solution }: Props) {
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-emerald-400/30 bg-surface-raised p-6 text-neutral-100 shadow-ambient backdrop-blur-2xl">
