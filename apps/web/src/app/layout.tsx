    ...
    <html lang="en" className="dark">
      <body className="relative min-h-screen text-neutral-100 antialiased selection:bg-brand-500/40 selection:text-white">
        <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_-10%,rgba(59,130,246,0.22),transparent_55%),radial-gradient(circle_at_90%_0%,rgba(236,72,153,0.18),transparent_55%)] blur-3xl" />
        </div>
